class APIList {
  static String? mainUrl = "Your main url goes here";
  static String? apiUrl = "your api url goes here";
  ...
  static String? paymentParcelLogs =
      "${server!}deliveryman/parcel-payment-logs";
  static String? changeStatus = "${server!}deliveryman/parcel-status-update";
  static String? updateLocation =
      "${server!}deliveryman/parcel-location-update";
}
